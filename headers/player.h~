...
struct player
{
	...
	if(i==0)
	{
	    ...
	    runSpeed = 0.005; runAngle= 0.1;
	    
	    maxSpeed = PosXY( player::dyingSpeed*2 , player::dyingSpeed*2 );
	    
	    TXR = new TextureIF( ImagePNG("BMPs/gameSpriteSheet2.png") );
    ...
    {
	acceleration = PosXY( getThrustRight() - (speed.X*air_resistance*0.1) , g + getThrustUp() /*- (speed.Y*air_resistance)*/ );
    }
